...
cursor.execute("""SELECT Ag_name, Rat_name, Grade, Outlook, Change, Date_str, Ent_name, Okpo, Ogrn, Inn, Finst, Ag_id, Rat_Sctr, Rat_type, Horizon, Scale_Typer, Currency, Backed_flag INTO [dbo].[Query_e] FROM [dbo].[Base] WHERE Scale_typer != 'Isc'""") #выбираем поля в отдельную таблицу
