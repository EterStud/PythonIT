...
cursor.execute("""SELECT Ag_name, Rat_name, Grade, Outlook, Change, Date_str, Ent_name, Okpo, Ogrn, Inn, Finst, Ag_id, Rat_Sctr, Rat_type, Horizon, Scale_Typer, Currency, Backed_flag INTO [dbo].[Query_a] FROM [dbo].[Base] WHERE Date_str != '01.07.2010' AND Grade !='Приостановлен' AND Grade !='Снят'""") #выбираем поля в отдельную таблицу
